  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <form className="space-y-4">
        ...
        <div><label className="block text-sm font-medium text-gray-700 mb-1">E-posta</label><input type="email" className="w-full p-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-pazar-red" placeholder="ornek@email.com" /></div>
